...
if submitted:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            carbon = result['predicted_soc_percent']
...
with col2:
    ...
    st.markdown("<p style='text-align: center; color: #888; font-size: 12px;'>📧 varia.agtech@gmail.com | @varia_support</p>", unsafe_allow_html=True)